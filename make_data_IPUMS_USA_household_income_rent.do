	...
	*****************************************************************/
		...
		if `readRaw' {
			...
			*****************************************************************/
				...
				replace metarea = met2013 if year==2019
				
				//variables that we'll keep only for the head
					local head_vars "renter rent rentgrs valueh age black educ occ1990 ind1990 statefip metarea farm hhtype sex bedrooms builtyr"
